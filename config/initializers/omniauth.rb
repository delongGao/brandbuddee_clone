Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '406898949368928', '6999bcaf6fe31bc63c85be6df690e320', {:scope => 'email,offline_access,publish_actions,publish_stream,user_birthday,user_about_me,user_location,user_likes,user_education_history,user_website,read_friendlists,user_interests,user_hometown,user_status'} if Rails.env.production?
end