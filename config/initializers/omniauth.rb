Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '253857021420655', 'ac29289c15bff7d445bb51e8f1646ada', :scope => 'email,offline_access,manage_pages' if Rails.env.development?
  provider :facebook, '278238152312772', 'fbf139910f26420742f3d88f3b25f9a9', {:scope => 'email,offline_access,manage_pages'} if Rails.env.production?
