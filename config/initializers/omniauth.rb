Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '524356277579122', '5284545fece303b49d41d1d627dcd99f', {:scope => 'email,offline_access,publish_actions,publish_stream,user_birthday,user_about_me,user_location,user_likes,user_education_history,user_website,read_friendlists,user_interests,user_hometown,user_status'} if Rails.env.production?
end