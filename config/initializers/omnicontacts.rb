...
Rails.application.middleware.use OmniContacts::Builder do
  importer :gmail, "163509294061.apps.googleusercontent.com", "LQVxAp3Qx1-_IcoDvipJnE2l", {:redirect_path => "/invite/gmail"} if Rails.env.development?
  importer :gmail, "265972249068.apps.googleusercontent.com", "Id_kxLjW6FqbDRhLfLqfWPvu", {:redirect_path => "/invite/gmail"} if Rails.env.production?
